  ...
  <>
    ...
    <div className={styles.desPlnts}>
      <div className={styles.desPlntsText}>
        ...
        <p>An international fleet of eight orbiters is studying the Red Planet from above including three NASA orbiters: 2001 Mars Odyssey, Mars Reconnaissance Orbiter, and MAVEN.</p>
        <p>These robotic explorers have found lots of evidence that Mars was much wetter and warmer, with a thicker atmosphere, billions of years ago.</p>
        <h2>
          <Link href={'/bookings'}>BOOK A FlIGHT RIGHT NOW!</Link>
        </h2>
      </div>
