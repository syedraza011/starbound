  ...
  return (
    <>
      ...
      <div className={styles.desPlnts}>
        ...
        <div>
          <Image src={mer} height="500" width="500" alt={"Mercury image"} />
        </div>
      </div>
      ...
      <div className={styles.desPlnts}>
        ...
        <div>
          <Image src={ven} height="500" width="500" alt={"Venus image"} />
        </div>
      </div>
      ...
      <div className={styles.desPlnts}>
        <h2>Mars</h2>
        <div>
          <Image src={mar} height="500" width="500" alt={"Mars image"} />
        </div>
      </div>
      ...
      <div className={styles.desPlnts}>
        <h2>Jupiter</h2>
        <div>
          <Image src={jup} height="500" width="500" alt={"Jupiter image"} />
        </div>
      </div>
      ...
      <div className={styles.desPlnts}>
        <h2>Saturn</h2>
        <div>
          <Image src={sat} height="350" alt={"Saturn image"} />
        </div>
      </div>
      ...
      <div className={styles.desPlnts}>
        <h2>Neptune</h2>
        <div>
          <Image src={nep} height="500" width="500" alt={"Neptune image"} />
        </div>
      </div>
      ...
      <div className={styles.desPlnts}>
        <h2>Uranus</h2>
        <div>
          <Image src={ura} height="500" width="500" alt={"Uranus image"} />
        </div>
      </div>
    </>
  );
